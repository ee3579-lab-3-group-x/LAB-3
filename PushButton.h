...
public:
	...
	void assign_pin_command(int in_buttonPin, command_list_enum in_simple_command, unsigned long int longpush_ms){setup_in_push_button(in_buttonPin, in_simple_command, longpush_ms);}
